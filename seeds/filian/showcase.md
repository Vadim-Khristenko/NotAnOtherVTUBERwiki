<!-- FilianWIKI seed content. (c) Vadim Khristenko, all rights reserved. Read for inspiration, reuse as is only with written permission. -->
# Formatting showcase

Every style the FilianWIKI editor understands, on one page. If it renders
